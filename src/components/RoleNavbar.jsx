...
const RoleNavbar=({isLoggedIn})=>{
    ...
    return (
        ...
        return (
            <ul className="navbar-nav ml-auto"> 
             <li className="nav-item active">
                <Link className="nav-link" to="/receivedorder">Received Orders </Link>
            </li>  
            <li className="nav-item active">
                <Link className="nav-link" to="/sprofile">Profile</Link>
            </li>
            <li className="nav-item active">
                <Link className="nav-link" to="/add-product">Add Service</Link>
            </li>
            <li className="nav-item active">
                <Link className="nav-link" to="/myproducts">My Services</Link>
            </li>          
            <li className="nav-item active">
                <Link className="nav-link" onClick={logout} to="#">Logout</Link>
            </li>        
    ...
    return (
        <ul className="navbar-nav ml-auto">  
         <li className="nav-item active">
            <Link className="nav-link" to="/assigncentre">Assign</Link>
        </li>             
        <li className="nav-item active">
