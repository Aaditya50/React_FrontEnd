                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6">
                            ...
                            <div className="form-group form-row">
                                <label className="col-sm-4 form-control-label"><b>Service Name</b></label>
                            ...
                            <div className="form-group form-row">
                                <label className="col-sm-4 form-control-label"><b>Category</b></label>
                                <div className="col-sm-8">
                            ...
                            <button className="btn btn-primary float-right"><b>Save Service</b></button>
                            </form>
                        </div>
                    </div>
                </div>
