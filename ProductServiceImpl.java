...
public class ProductServiceImpl implements ProductService{
	...
	@Autowired ServiceCentreService sellerService;
	@Override
	...
	@Override
	public List<Product> findProducts(int serviceCentreId) {
		// TODO Auto-generated method stub
		return dao.findByServiceCentre(ServiceCentreService.findById(serviceCentreId),Sort.by(Sort.Direction.DESC,"prodid"));
	}

	@Override
	public void updateProduct(Product p) {
		Product pp=dao.getById(p.getProdid());
		p.setServiceCentre(pp.getServiceCentre());
		dao.save(p);
	}
